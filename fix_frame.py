...
for p in range(100):
    ...
    #shapeを用いてフレーム数の調整後の確認表示
    print("------------------")
    print("単語", p, "単語", q)
    print("テンプレートのフレーム数", uninput_framenum_frame)
    print(template_data_3d_frame.shape)
    print("未入力のフレーム数", template_framenum_frame)
    print(uninput_data_3d_frame.shape)